...
public class YahooWeather {
  ...
  public int getTemperatureLowTomorrow(){
    return mainXML.getChild("channel/item").getChild(15).getInt("low");
  }
  
  public int getTemperatureHighTomorrow(){
    return mainXML.getChild("channel/item").getChild(15).getInt("high");
  }
  
  public String getWeatherConditionTomorrow(){
    return mainXML.getChild("channel/item").getChild(15).getString("text");
  }
  
  public int getWeatherConditionCodeTomorrow(){
    return mainXML.getChild("channel/item").getChild(15).getInt("code");
  }
  
  public String getWeekdayTomorrow(){
    return mainXML.getChild("channel/item").getChild(15).getString("day");
  }
  
  public int getTemperatureLowDayAfterTomorrow(){
    return mainXML.getChild("channel/item").getChild(17).getInt("low");
  }
  
  public int getTemperatureHighDayAfterTomorrow(){
    return mainXML.getChild("channel/item").getChild(17).getInt("high");
  }
  
  public String getWeatherConditionDayAfterTomorrow(){
    return mainXML.getChild("channel/item").getChild(17).getString("text");
  }
  
  public int getWeatherConditionCodeDayAfterTomorrow(){
    return mainXML.getChild("channel/item").getChild(17).getInt("code");
  }
  
  public String getWeekdayDayAfterTomorrow(){
    return mainXML.getChild("channel/item").getChild(17).getString("day");
  }
}
